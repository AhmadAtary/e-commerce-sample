...
') }}\" required autofocus autocomplete=\"name\" style=\"width: 100%; padding: 0.75rem; border-radius: 5px; border: none; background-color: #6b7280; color: #fff;\">
                @error(\'name\')
...
') }}\" required autocomplete=\"username\" style=\"width: 100%; padding: 0.75rem; border-radius: 5px; border: none; background-color: #6b7280; color: #fff;\">
                @error(\'email\')
                    <div style=\"color: #f56565; font-size: 0.9rem; margin-top: 0.25rem;\">{{ $message }}</div>
                @enderror
            </div>
